...
classes = ['ChildMale','ChildFemale','YoungMen','YoungWomen','MiddleAgeMen','MiddleAgeWomen','OldAgeMen','OldAgeWomen']
...
def upload():
    target = os.path.join(APP_ROOT, r'C:\Users\sathe\Downloads\images\Men')
